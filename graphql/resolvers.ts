...
export const resolvers = {
  ...
  College: {
    ...
    privatemnts: async (parent: any, _args: any, context: Context) => {
      return await context.prisma.privatemnt.findMany({
        where: {
          collegeId: parent.id,
        },
      });
  ...
  Mutation: {
    ...
    //Privatemnt Mutations

    // add Privatemnt
    addPrivatemnt: async (_parent: any, args: any, context: Context) => {
    ...
    // delete state
    deletePrivatemnt: async (_parent: any, args: any, context: Context) => {
      return await context.prisma.privatemnt.delete({
        where: {
          id: args.id,
        },
      });
