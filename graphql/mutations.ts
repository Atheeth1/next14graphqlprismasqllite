...
export const ADD_PRIVATE= gql`
	mutation Mutation($collegeId: ID!, $nameprivate: String,$descriptionprivate: String) {
		addPrivate(collegeId: $collegeId, nameprivate: $nameprivate,descriptionprivate:$descriptionprivate) {
			id
			nameprivate
			descriptionprivate
			collegeId
